enum ActionGame {
  ...
  failedTwoPoint(name: "2 pts raté ", type: ActionType.failedShot),
  failedThreePoint(name: "3 pts raté ", type: ActionType.failedShot),
  ...
  counter(name: "Contre", type: ActionType.counter);
